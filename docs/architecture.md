...
- Сбор и разметка датасета для корректной оценки качества и выявления проблемных кейсов и таргетное их решение.
- Аугментации (блики, overlap текста) для повышения устойчивости решения к проблемным сценариям.
